...
sim_reg_stats(struct stat_sdb_t *sdb)
{
  ...
  stat_reg_counter(sdb, "sim_num_RAW_hazard_q1_stall_1",
		   "total number of RAW hazards 1 cycle (q1)",
		   &sim_num_RAW_hazard_q1_stall_1, sim_num_RAW_hazard_q1, NULL);
  
  stat_reg_counter(sdb, "sim_num_RAW_hazard_q1_stall_2",
		   "total number of RAW hazards 2 cycle(q1)",
		   &sim_num_RAW_hazard_q1_stall_2, sim_num_RAW_hazard_q1, NULL);
  ...
  stat_reg_formula(sdb, "CPI_from_RAW_hazard_q1",
		   ...
		   "(sim_num_RAW_hazard_q1_stall_1 + 2*sim_num_RAW_hazard_q1_stall_2)/sim_num_insn", NULL);
...
#include "machine.def"
	...
	sim_num_loads++;
      ...
      for (i = 0; i < 3; i++) {
	    ...
	    reg_ready[r_in [i]] = sim_num_insn -1;
            break;
         }
      }
